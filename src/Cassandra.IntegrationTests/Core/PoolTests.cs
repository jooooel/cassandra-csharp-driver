...
namespace Cassandra.IntegrationTests.Core
{
    ...
    public class PoolTests : TestGlobals
    {
        ...
        public void FailoverTest()
        {
            ...
            using (var cluster = SessionBuilder().AddContactPoint(nonShareableTestCluster.InitialContactPoint).WithReconnectionPolicy(policy).Build())
            {
