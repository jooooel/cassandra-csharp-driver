...
namespace Cassandra.IntegrationTests.Policies.Tests
{
    ...
    public class ReconnectionPolicyTests : TestGlobals
    {
        ...
        {
            var builder = SessionBuilder().WithReconnectionPolicy(new ExponentialReconnectionPolicy(2*1000, 5*60*1000));
        ...
        {
            Builder builder = SessionBuilder().WithReconnectionPolicy(new ConstantReconnectionPolicy(25*1000));
